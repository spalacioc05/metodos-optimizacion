...
export const METHOD_CONFIGS = {
  ...
  randomSearch: {
    ...
    parameters: [
      { name: 'xl', label: 'X mínimo', type: 'number', required: true },
      { name: 'xu', label: 'X máximo', type: 'number', required: true },
      { name: 'yl', label: 'Y mínimo', type: 'number', required: true },
      { name: 'yu', label: 'Y máximo', type: 'number', required: true },
      { name: 'zl', label: 'Z mínimo (opcional)', type: 'number', required: false },
      { name: 'zu', label: 'Z máximo (opcional)', type: 'number', required: false },
